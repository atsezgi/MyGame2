...
public class SixthLevelActivity extends AppCompatActivity {
    ...
    public void  FifthLevel(){
        Intent intent = new Intent(SixthLevelActivity.this, SeventhLevelActivity.class);
    ...
    public void RandomNumberAssign() {
        ...
        int rndLeft = random.nextInt(121)-60;
        int rndRight = random.nextInt(121)-60;
