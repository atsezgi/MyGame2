...
public class NinethLevelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nineth_level);
    ...
    public void  FifthLevel(){
        Intent intent = new Intent(NinethLevelActivity.this, TenthLevelActivity.class);
