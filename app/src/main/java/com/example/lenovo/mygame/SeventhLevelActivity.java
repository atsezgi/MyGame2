...
public class SeventhLevelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seventh_level);
    ...
    public void  FifthLevel(){
        Intent intent = new Intent(SeventhLevelActivity.this, EighthLevelActivity.class);
    ...
    public void RandomNumberAssign() {
        ...
        int rndLeft = random.nextInt(201)-100;
        int rndRight = random.nextInt(201)-100;
